...
<html align="center"><font size='4'>
    ...
    <?php
                    ...
                    echo $user;
                    echo "&nbsp;&nbsp;";
                    echo "<a href='entrada2.php' style='text-decoration:none; font-weight:bold;'>&nbsp;&nbsp;Sólido&nbsp;</a>";
                    echo "&nbsp;&nbsp;";
                    echo "&nbsp;&nbsp;";
...
<hr/>
            ...
            <form method='POST'>
                ...
                <fieldset id="contorno1" style="width:600px;height:200px; margin:auto">
                ...
                <fieldset id="contorno1" style="width:1200px;height:100px; margin: auto">
                    ...
                    <table align=center border="1" width="1000px">
                        <tr align=center>
                            <th>Radionuclídeo</th>
                            <th>Estado</th>
                            <th>Atividade medida<br>(Bq/m3)</th>
                            <th>Data da<br>medida</th>
                            <th>Atividade<br>para descarte<br>(Bq/m3)</th>
